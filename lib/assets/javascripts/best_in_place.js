...
BestInPlaceEditor.prototype = {
    ...
    update: function () {
        ...
        //create!!!!
        var value = editor.element.data('bip-display-as');
    ...
    create: function(dataFieldsSelector) {
      ...
      editor.ajax({
          ...
          "error": function (request, error) {
            ...
            dataFieldsSelector.first().trigger(jQuery.Event("best_in_place:not_created"), [request, error]);
          }
      });
    ...
    loadErrorCallback: function (request, error) {
        ...
        //if(!this.element.data('bip-manual-update'))
        //  this.activateText(this.oldValue);
